...
function BootView(): JSX.Element {
  ...
  if (!runtime) {
    return <View style={styles.boot}><ActivityIndicator color="#b58900" size="large" /><Text style={styles.text}>Starting local dashboard…</Text></View>;
  }
  return <AppNavigation />;
}

export function AppShell(): JSX.Element {
  return <AppProvider><BootView /></AppProvider>;
}
